...
internal static class PromptAgentExtensions
{
    ...
    internal static IEnumerable<Azure.AI.Agents.Persistent.ToolDefinition> GetFoundryToolDefinitions(this PromptAgent promptAgent)
    {
    ...
    /// </summary>
    /// <param name="promptAgent">Instance of <see cref="PromptAgent"/></param>
    internal static ToolResources GetFoundryToolResources(this PromptAgent promptAgent)
    {
        Throw.IfNull(promptAgent);
